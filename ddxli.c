...
static int saParseXColor( DisplayInfo* dinfo, strbyte* spec, XColor* xcolor );
...
int xliParseXColor( DisplayInfo* dinfo, strbyte* spec, XColor* xcolor )
{
	int stat;
